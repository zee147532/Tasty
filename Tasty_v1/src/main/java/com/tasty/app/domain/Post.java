...
public class Post implements Serializable {
    ...
    public void setTypeOfDishes(Set<TypeOfDish> typeOfDishes) {
        if (this.typeOfDishes != null) {
            this.typeOfDishes.forEach(i -> i.setPost(null));
        }
        if (typeOfDishes != null) {
            typeOfDishes.forEach(i -> i.setPost(this));
        }
        this.typeOfDishes = typeOfDishes;
    }

    public Post typeOfDishes(Set<TypeOfDish> typeOfDishes) {
        this.setTypeOfDishes(typeOfDishes);
        return this;
    }

    public Post addTypeOfDish(TypeOfDish typeOfDish) {
        this.typeOfDishes.add(typeOfDish);
        typeOfDish.setPost(this);
        return this;
    }

    public Post removeTypeOfDish(TypeOfDish typeOfDish) {
        this.typeOfDishes.remove(typeOfDish);
        typeOfDish.setPost(null);
        return this;
    }
